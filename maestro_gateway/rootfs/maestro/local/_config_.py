...
_MQTT_TOPIC_SUB = 'Musa/Command/'	# Publish command messages here (mandatory trailing slash)
_MQTT_TOPIC_PUB = 'Musa/'	        # Information messages by daemon are published here (mandatory trailing slash)
